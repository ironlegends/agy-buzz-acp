...
```text
agy-buzz-manage install --archive agy-buzz-acp-0.5.8.tgz --sha256 <sha256> --root C:\agy\agy-buzz-acp --harness C:\Users\me\harness.json
```
...
```text
agy-buzz-manage install --archive agy-buzz-acp-0.5.8.tgz --sha256 <sha256> --root C:\agy\agy-buzz-acp --harness C:\Users\me\harness.json --apply
```
