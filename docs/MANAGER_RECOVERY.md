...
A durable phase journal and automatic, hash-checked interruption recovery remain a separate design task. This patch does not add automatic lock deletion or modify any installed harness.
